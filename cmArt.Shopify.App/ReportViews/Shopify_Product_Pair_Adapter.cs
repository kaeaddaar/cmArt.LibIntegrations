...
{
    public class Shopify_Product_Pair_Adapter : IShopify_Product_Pair_Flat
    {
        ...
        public Shopify_Product_Pair_Adapter()
        {
            _Init();
        }
        public Shopify_Product_Pair_Adapter(Generic_Pair<Shopify_Product> shopify_Product_Pair)
        {
